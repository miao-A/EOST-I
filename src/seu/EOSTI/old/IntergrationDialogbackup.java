...
public class IntergrationDialogbackup extends org.eclipse.swt.widgets.Dialog {
	...
	*/
	public static void main(String[] args) {
		try {
			...
			IntergrationDialogbackup inst = new IntergrationDialogbackup(shell, SWT.NULL);
			inst.open();
		} catch (Exception e) {
			e.printStackTrace();
		}
	...
	public IntergrationDialogbackup(Shell parent, int style) {
		super(parent, style);
	}
...
//			dialogShell = new Shell(parent, SWT.CLOSE | SWT.MAX |SWT.MIN);
			...
			}
			{
				...
				AnalyzeBtnLData.left =  new FormAttachment(0, 1000, 77);
				AnalyzeBtnLData.top =  new FormAttachment(0, 1000, 190);
