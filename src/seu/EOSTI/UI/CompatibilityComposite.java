...
public class CompatibilityComposite extends Composite {
	...
	public CompatibilityComposite(Composite parent, int style) {
		...
		methodInfoTree.setBounds(20, 85, 604, 395);
		...
		CompatibilityBtn.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				...
				for(TypeChangeRecoder tcr : modifiedType){					
					...
					String itemString = tcr.getNewTypeModel().getPackage() + " " + tcr.getNewTypeModel().getClassName() +
							" new Method:"+thenewCount + " removed Method:" + theremovedCount +" unchangeCount:"+theunchangeCount +" modifiedCount:"+themodifiedCount;
...
//					typeItem.setText(tcr.getOldTypeModel().getPackage()+" 2" +tcr.getOldTypeModel().getClassName());
		...
		CompatibilityBtn.setBounds(571, 10, 53, 69);
